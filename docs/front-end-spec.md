...
**AI助手内部导航：**
- **主导航：** 新对话 / 历史对话 / 返回主站
- **侧边导航：** 角色推荐问题 / 资源推送 / 政策动态（基于角色动态展示）
- **面包屑：** 主站首页 > AI助手 > 当前会话

**运营后台导航：**
- **左侧垂直菜单：** 知识库管理 / 脱敏审核 / 问答审核 / 反馈管理 / 对话日志 / 内容配置 / 数据统计
...
│                │                                             │
│  ┌───────────┐ │  🤖 根据《河南省县域结对型城乡学校共同体     │
│  │ 📢 政策动态│ │     建设指南》第三章第二节[1]，结对模式      │
│  │            │ │     主要包括以下几种：                       │
│  │ • 最新通知  │ │     1. "1+1"模式：一所城镇校对口...         │
│  │ • 文件更新  │ │     2. "1+1+N"模式：...                    │
│  └───────────┘ │ │     ★ 评分 ☆☆☆☆☆                         │
│                │ │     引用：[1] 《建设指南》第三章第二节        │
│  ┌───────────┐ │                                             │
...
**基础框架：** Element Plus（与主站 edu.51xiaoping.com 技术栈一致）
...
| **侧边栏推荐** | "暂无推荐内容" | 3行骨架卡片 | 静默降级，不显示 | 推荐列表 |
...
| `SidePanel` | `role: UserRole`, `collapsed: boolean` | `@toggle` | — |
...
3. 与架构师确认前端技术栈（Vue 3 + Element Plus）
